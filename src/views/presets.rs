...
pub(super) fn PresetsView() -> Element {
    ...
    let selected_index = (ctx.active_preset)().min(presets.len().saturating_sub(1));
        ...
        section { class: "screen-grid",
            div { class: "main-column",
                div { class: "list-header",
                    ...
                    button {
                        ...
                        onclick: move |_| duplicate_preset(ctx),
                        "{i18n::t(\"create_preset\")}"
                    }
                }
                div { class: "preset-card-grid",
                    for (index, preset) in presets.iter().cloned().enumerate() {
                        button {
                            ...
                            span { class: "format-title", "{localized_preset_name(&preset.name)}" }
            ...
            aside { class: "side-panel editor-panel",
                ...
                EditablePresetField {
                    ...
                    field: "format_label".to_string(),
                    value: selected.format_label,
                }
                EditablePresetField {
                    label: i18n::t("preset_format_rule"),
                    field: "format_rule".to_string(),
                    value: selected.format_rule,
                }
                EditablePresetField {
                    label: i18n::t("audio_format"),
                    field: "audio_format".to_string(),
                    value: selected.audio_format,
                }
                EditablePresetField {
                    label: i18n::t("quality"),
                    field: "audio_quality".to_string(),
                    value: selected.audio_quality,
                }
                EditablePresetField {
                ...
                EditablePresetField {
                    label: i18n::t("output_template"),
                    field: "output_template".to_string(),
                    value: selected.output_template,
                }
                EditablePresetField {
                    label: i18n::t("extra_flags"),
                    field: "extra_flags".to_string(),
                    value: selected.extra_flags,
                }
                button {
                    class: "primary-button full",
                    onclick: move |_| apply_preset(ctx),
                    "{i18n::t(\"use_preset\")}"
                }
            }
        }
