...
pub(super) fn ReadyView() -> Element {
    ...
    match analysis {
                ...
                section { class: "screen-grid",
                    div { class: "main-column",
                        ...
                        div { class: "choice-row three-up",
                            ModeButton {
                                mode: DownloadType::FullVideo,
                                label: DownloadType::FullVideo.label(),
                                detail: i18n::t("mode_full_video_detail"),
                            }
                            ModeButton {
                                mode: DownloadType::AudioOnly,
                                label: i18n::t("mode_extract_audio"),
                                detail: i18n::t("mode_extract_audio_detail"),
                            }
                            ModeButton {
                                mode: DownloadType::VideoOnly,
                                label: DownloadType::VideoOnly.label(),
                                detail: i18n::t("mode_video_only_detail"),
                            }
                        }
        ...
        None => {
            rsx! {
                EmptyState {
                    title: i18n::t("empty_nothing_analyzed_title"),
                    message: i18n::t("empty_nothing_analyzed_message"),
                }
            }
        }
    }
