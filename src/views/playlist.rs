...
pub(super) fn PlaylistView() -> Element {
    ...
    match analysis {
                ...
                section { class: "screen-grid",
                    ...
                    aside { class: "side-panel quiet-panel",
                        ...
                        button {
                            ...
                            "{i18n::t(\"add_selected_to_queue\")}"
                        }
                        button {
                            class: "secondary-button full",
                            onclick: move |_| {
                                select_first_n(ctx, 10);
                                add_analysis_to_queue(ctx);
                            },
                            "{i18n::t(\"download_first_10\")}"
                        }
                    }
                }
            }
        ...
        None => {
            rsx! {
                EmptyState {
                    title: i18n::t("empty_no_playlist_title"),
                    message: i18n::t("empty_no_playlist_message"),
                }
            }
        }
    }
